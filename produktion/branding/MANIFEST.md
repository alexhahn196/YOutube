...
- `avatar_full.png` — **Kanal-Avatar** (800×800). Bildmarke „getracktes Signal" (Reticle-Ring + Broadcast-Arcs + Kern), textlos → liest sich bis 48px im Feed. YouTube: Anpassen → Branding → Bild.
...
- `make_logo.py` — zeichnet Avatar/Wortmarke/Wasserzeichen (reines Pillow, vektorartig).
