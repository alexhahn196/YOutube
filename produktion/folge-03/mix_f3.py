#!/usr/bin/env python3
"""Mix F3: 3 Musik-Beds (Reuse aus F1/F2) je Akt loopen, unter VO ducken (Sidechain),
mit Silent-4K-Video muxen -> f3_FINAL_4k.mp4. Akte: Seg 1-3 / 4-6 / 7-10."""
...
vo_full=os.path.join(WORK,"f3_vo_full.wav")
...
final=os.path.join(HERE,"f3_FINAL_4k.mp4")
