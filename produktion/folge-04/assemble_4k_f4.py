...
EDL = [
 ...
 ["NX09","NV08","NV14","C19","NY01","NX07"],     # 6 verdict Q1 (BLC1-Forensik, Standard, Verdict, Ehman-Zitat, Flip)
 ["NV13","NY04","NX09","NY02","NV14"],           # 7 explanations die (Komet, Stern, RFI, Horn-Fail, Urteil)
