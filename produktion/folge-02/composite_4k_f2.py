#!/usr/bin/env python3
"""Composite SIGNAL Ep02 overlays onto f2_FINAL_4k -> f2_MASTER_4K.mp4 (2160p).
...
VD = meta["video_dur"]
src = os.path.join(HERE,"f2_FINAL_4k.mp4"); out = os.path.join(HERE,"f2_MASTER_4K.mp4")
...
print("compositing 4K:", len(timed),"timed overlays + HUD -> f2_MASTER_4K.mp4")
