#!/usr/bin/env python3
"""Composite SIGNAL overlays onto v4_FINAL -> f2_MASTER.mp4.
...
VD = meta["video_dur"]
src = os.path.join(HERE,"f2_FINAL.mp4"); out = os.path.join(HERE,"f2_MASTER.mp4")
...
print("compositing", len(timed),"timed overlays + HUD -> f2_MASTER.mp4")
