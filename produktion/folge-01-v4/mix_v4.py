...
Output: v4_FINAL.mp4 (visuals + VO + scored music). No overlays yet."""
...
act=[sum(vslot[0:4]), sum(vslot[4:9]), sum(vslot[9:14])]
...
silent=os.path.join(HERE,"v4_video_silent.mp4"); vo=os.path.join(HERE,"v4_vo_full.wav")
final=os.path.join(HERE,"v4_FINAL.mp4")
