...
3. **Skript-Gate VOR der Vertonung (neu 29.07.2026):** `produktion/pipeline/skript_lint.py <VO> --packaging <Upload-Paket> --chips <chips.json>` muss mit Exit-Code 0 durchlaufen. Prüft maschinell, was bisher nur Prosa war: ⚠️-Regel (ship-blocking), Laufzeit 13–15 Min, §5c (Eigennamen · Fachzahlen **auch ausgeschrieben** · Satzlänge · Fremdwörter), **§5d (kein „et al."/arXiv/DOI im gesprochenen Wort; Chips im Bild max. 4, Rolle statt Zitation)**, Schaufenster-Verneinungen. Erzeugungs-Prozess dazu: Playbook **§15** (6 Durchgänge, nie one-shot; Chat = Urteil, Code = Regel).
