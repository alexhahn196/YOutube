...
## F1 — 3I/ATLAS (bereits live, Alt-Thumb ohne A/B)
| Variante | Datei | Hypothese | CTR 48 h | CTR 7 d | Gewinner? | Learning |
|---|---|---|---|---|---|---|
| v1 (alt) | folge-01/… | — (vor §13 entstanden; Autopsie: 41/255 Luminanz, 61 % schwarz, Verdict „MOSTLY NOISE" im Bild) | — | — | — | Negativ-Referenz: dunkel + Verdict im Schaufenster = 0-Klick-Beleg (§13) |
...
| Variante | Datei | Hypothese | CTR 48 h | CTR 7 d | Gewinner? | Learning |
|---|---|---|---|---|---|---|
| Master „TURNED AROUND?" | folge-03/thumbnail/master_f3_TURNEDAROUND.jpg | | | | | |
| Challenger | | | | | | |

## F4 — Wow!-Signal (Premiere Sa 01.08.2026)
| Variante | Datei | Hypothese | CTR 48 h | CTR 7 d | Gewinner? | Learning |
|---|---|---|---|---|---|---|
| Master „SIX CHARACTERS" | folge-04/thumbnail/master_f4_SIXCHARACTERS.jpg | Diegetischer Ehman-Kreis (echtes Dokument-Artefakt) + Printout-Makro = „da stimmt was nicht"-Neugier | | | | |
| Challenger (Crop) | folge-04/thumbnail/variantB_f4_SIXCHARACTERS_crop.jpg | Engerer Crop → 6EQUJ5 größer, mobil besser lesbar | | | | |
